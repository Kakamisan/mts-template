...
find . -type f \( -name "TemplateCharacter.java" -o -name "TemplateMod.java" -o -name "TemplateRelic.java" -o -name "TemplatePower.java" \) -exec sh -c 'CHARACTER="'$CHARACTER'"; mv "$0" "${0/Template/$CHARACTER}"' {} \;